tabimport Card from esc'./components/GettingStarted/Card'
import Button from 'tab./components/button'
...
To get started, refer to our [Chain Onboarding Guide](/advanced/multichain/overview).
